        ...
        "levels": {
            "1": {
                ...
                "vocabulary": [
                    ...
                    {"word": "space", "meaning": "宇宙、空間、あき"},
                    {"word": "bright", "meaning": "明るい、輝かしい、賢い"}
                ],
                "grammar": "【基本的な文法】\nこのレベルでは、'There is / are'（〜がある）という基本的な存在を表す表現が使われています。\n例: There is a new telescope in space.\nまた、'Its name is...' のように代名詞の所有格を用いたシンプルな自己紹介的な表現が中心です。",
                "sentences": [
            ...
            "2": {
                ...
                "vocabulary": [
                    ...
                    {"word": "launch", "meaning": "打ち上げる、開始する、発進させる"},
                    {"word": "faint", "meaning": "かすかな、弱々しい、気が遠くなる"}
                ],
                "grammar": "【受動態と接続詞】\n'It was launched'（打ち上げられた）という過去形の受動態が登場しています。be動詞＋過去分詞の形に注目しましょう。\nまた、'Because...' を使った理由の説明など、複文（文の中に文が入る形）が使われ始めています。",
                "sentences": [
            ...
            "3": {
                ...
                "target_time": "3 mins",
                "vocabulary": [
                    {"word": "leap", "meaning": "飛躍、跳躍、跳ぶ"},
                    {"word": "infrared", "meaning": "赤外線の"},
                    {"word": "fundamental", "meaning": "根本的な、基本的な、重要な"}
                ],
                "grammar": "【関係代名詞と現在分詞】\n'infrared light, which is invisible...' のように、関係代名詞の非制限用法が登場しています。直前の言葉に補足情報を加える役割があります。\nまた、'clouds of dust where...' の関係副詞など、場所や状況を詳しく説明する表現が多用されています。",
                "sentences": [
            ...
            "4": {
                ...
                "vocabulary": [
                    ...
                    {"word": "utilize", "meaning": "利用する、役立てる"},
                    {"word": "transformative", "meaning": "変化をもたらす、変革的な"}
                ],
                "grammar": "【分詞構文と高度な語彙】\n'Launched as the successor...' のように、文頭に過去分詞が来る分詞構文が使われています。これは 'As it was launched...' を簡略化した形です。\n'regarded as'（〜とみなされる）や 'transformative insights'（変革的な洞察）といった、論文やニュースで使われる硬い表現が増えています。",
                "sentences": [
            ...
            "5": {
                ...
                "target_time": "5 mins",
                "vocabulary": [
                    {"word": "catalyze", "meaning": "促進する、触媒となる"},
                    {"word": "dismantle", "meaning": "打ち砕く、解体する、取り除く"},
                    {"word": "meticulous", "meaning": "綿密な、細心の注意を払った"},
                    {"word": "ontological", "meaning": "存在論的な"}
                ],
                "grammar": "【最高難易度の構文と学術表現】\n'By capitalizing on...'（〜を活用することで）や 'facilitate the intricate chemical characterization'（複雑な化学的特性評価を容易にする）など、名詞化（Nominalization）を多用した学術的な文章構成になっています。\n文脈から正確に意味を汲み取る必要があり、抽象度の高い単語が連続する「教養あるネイティブ向け」のスタイルです。",
                "sentences": [
